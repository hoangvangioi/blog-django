                        ...
                        (s.prototype.init = function () {
                            ...
                            (s.prototype.build = function (e) {
                                ...
                                for (var s in window.lgModules)
                                    t.modules[s] = new window.lgModules[s](
                                        t.el
                                    );
                                if (
                                    (t.slide(e, !1, !1),
                            ...
                            (s.prototype.structure = function () {
                                ...
                                if (
                                    ...
                                    var a =
                                        this.outer.querySelector(".lg-inner");
                                    l.default.setVendor(
                                        a,
                            ...
                            (s.prototype.addHtml = function (e) {
                                ...
                                ".lg-sub-html" === this.s.appendSubHtmlTo
                                    ...
                                    : this.___slide[e].insertAdjacentHTML(
                                          "beforeend",
                                          t
                                      ),
                                    void 0 !== t &&
                            ...
                            (s.prototype.preload = function (e) {
                                ...
                                for (
                                    t = 1;
                                    t <= this.s.preload &&
                                    !(t >= this.items.length - e);
                                    t++
                                )
                                    this.loadContent(e + t, !1, 0);
                                for (
                                    s = 1;
                                    s <= this.s.preload && !(e - s < 0);
                                    s++
                                )
                            ...
                            (s.prototype.loadContent = function (e, t, s) {
                                ...
                                if (i.s.dynamic) {
                                    if (
                                        ...
                                        f(
                                            i.s.dynamicEl[e].responsive.split(
                                                ","
                                            )
                                        );
                                    }
                                    ...
                                    (n =
                                        i.items[e].getAttribute("data-srcset")),
                                        (u =
                                            i.items[e].getAttribute(
                                                "data-sizes"
                                            ));
                            ...
                            (s.prototype.destroy = function (e) {
                                ...
                                (this.lGalleryOn = !1),
                                    ...
                                    setTimeout(function () {
                                        try {
                                            t.outer &&
                                                t.outer.parentNode.removeChild(
                                                    t.outer
                                                ),
                                                document.querySelector(
                                                    ".lg-backdrop"
