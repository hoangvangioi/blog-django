    ...
    null != (r = document.querySelector(".navbar-sticky")) &&
                                    ...
                                    (a.innerHTML = r),
                                        e.startsWith("data:image")
                                            ...
                                            ? ((o.innerHTML = ""),
                                              (o.className = ""),
                                              (o.className =
                                                  "file-drop-icon ci-video"))
                                            : ((o.innerHTML = ""),
                                              (o.className = ""),
                                              (o.className =
                                                  "file-drop-icon ci-document"));
                                }),
        ...
        (function () {
            for (
                ...
                new Drift(e[t], {
                    paneContainer:
                        e[t].parentElement.querySelector(".image-zoom-pane"),
                });
        })(),
        (function () {
                    ...
                    var t = (function (e) {
                        ...
                        setInterval(function () {
                            ...
                            0 <= e &&
                                ...
                                null != c &&
                                    (c.innerHTML = r < 10 ? "0" + r : r),
                                null != s &&
                                    (s.innerHTML = n < 10 ? "0" + n : n),
                                null != i &&
                                    (i.innerHTML = a < 10 ? "0" + a : a));
                        }, 1e3);
                    })(e);
            ...
            if (0 !== e.length || 0 !== t.length || 0 !== l.length) {
                ...
                for (var b = 0; b < l.length; b++)
                    !(function (e) {
                        ...
                        if (
                            (l[e].classList.add("cz-pie-chart-" + e), null != n)
                        ) {
                            t = JSON.parse(n);
                        ...
                        new Chartist.Pie(l[e], r, {
                            labelInterpolationFnc: function (e) {
                                return (
                                    Math.round((e / r.series.reduce(o)) * 100) +
                                    "%"
                                );
                            },
                        });
        ...
        (function () {
            for (
                var l = document.querySelectorAll(".range-slider"), e = 0;
                e < l.length;
                e++
            )
                !(function (e) {
                    ...
                    noUiSlider.create(t, {
                        ...
                        t.noUiSlider.on("update", function (e, t) {
                            e = (e = e[t]).replace(/\D/g, "");
                            t
                                ? (n.value = Math.round(e))
                                : (r.value = Math.round(e));
                        }),
        ...
        (function () {
            for (
                var o = document.querySelectorAll('[data-bs-toggle="select"]'),
                    e = 0;
                e < o.length;
                e++
            )
                !(function (e) {
                    for (
                        var t = o[e].querySelectorAll(".dropdown-item"),
                            ...
                            n = o[e].querySelector('input[type="hidden"]'),
                            a = 0;
                        a < t.length;
                        a++
                    )
